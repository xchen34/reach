export const fr = {
  ...
  staff: {
    ...
    cases: {
      ...
      needsReviewLabel: "A revoir",
      addedToHelpListLabel: "Ajoute a la liste d'aide",
      combinedLabel: "Regroupes",
      noActionNeededLabel: "Aucune action",
      currentEventLabel: "Evenement en cours",
      allEventsOption: "Tous les evenements",
      noReportsMatchFilter: "Aucun nouveau signalement ne correspond a ce filtre.",
      noHelpRequestsYet: "Aucune demande d'aide n'a encore ete ajoutee.",
      ...
      latestUpdateLabel: "Note de statut",
      latestUpdateFallback: "Aucune note de statut pour le moment.",
      ...
      lastSeenLabel: "Vu pour la derniere fois",
      ageLabel: "Age",
      phoneLabel: "Telephone",
      reportTimeLabel: "Signale",
      viewReportAction: "Voir le signalement",
      addToHelpListAction: "Ajouter a la liste d'aide",
      addedToHelpListStatus: "Ajoute a la liste d'aide",
      combineReportsAction: "Regrouper les signalements",
      noActionNeededAction: "Aucune action",
      openTaskAction: "Ouvrir la tache",
      noteAction: "Note",
      noteLabel: "Note",
      noteBadgeLabel: "Note",
      noteSaveAction: "Enregistrer",
      noteSaving: "Enregistrement...",
      noteCancelAction: "Annuler",
      noteRequired: "Ecrivez une note avant d'enregistrer.",
      noteTooLong: "La note ne peut pas depasser 100 caracteres.",
      noteSaveError: "La note n'a pas ete enregistree. Reessayez.",
      possibleDuplicateLabel: "Doublon possible",
      possibleUpdateLabel: "Peut etre un complement",
      mergedIntoExistingTaskLabel: "Deja regroupe dans une tache",
      incompleteDetailsLabel: "Details incomplets",
      unknownSubjectTypeLabel: "Type a confirmer",
      claimAction: "Prendre la tache",
      reassignToMeAction: "Me reassigner",
      foundSafeAction: "Retrouve·e / en securite",
      confirmDeathAction: "Confirmer le deces",
      returnAction: "Remettre en attente",
      viewDetailsAction: "Voir les details",
      confirmDeathPrompt:
        "Confirmer que cette personne ou cet animal doit etre marque comme deces confirme ? A utiliser seulement si l'information vient d'une source credible.",
      operationalStatuses: {
        unassigned: "En attente d'un benevole",
        inProgress: "Suivi en cours",
        personFoundAlive: "Retrouve·e en securite",
        petFoundAlive: "Retrouve en securite",
        personConfirmedDeceased: "Deces confirme",
        petConfirmedDeceased: "Deces confirme",
      },
      reportStatuses: {
        awaiting_review: "A revoir",
        linked_to_case: "Ajoute a la liste d'aide",
        linked_to_new_case: "Ajoute a la liste d'aide",
        linked_to_existing_case: "Regroupe avec un autre signalement",
        out_of_scope: "Aucune action",
        invalid_or_insufficient: "Aucune action",
      },
      summaryCards: {
    ...
    detail: {
      ...
      description: "Consultez les details de la tache et enregistrez la prochaine action benevole.",
      ...
      claimSubmit: "Prendre la tache",
      nextActionTitle: "Prochaine action",
      reassignToMeAction: "Me reassigner",
      foundSafeAction: "Retrouve·e / en securite",
      confirmDeathAction: "Confirmer le deces",
      returnAction: "Remettre en attente",
      correctStatusAction: "Modifier le statut",
      statusCorrectionTitle: "Modifier le statut",
      currentStatusLabel: "Statut actuel",
      targetStatusLabel: "Nouveau statut",
      optionalNoteLabel: "Note (facultative)",
      optionalNotePlaceholder: "Expliquez brievement pourquoi le statut change",
      cancelStatusCorrection: "Annuler",
      confirmStatusCorrection: "Confirmer la modification",
      statusCorrectionSuccess: "Le statut a ete modifie.",
      correctionStatuses: {
        unassigned: "En attente",
        inProgress: "En cours",
        foundAlive: "Retrouve·e / en securite",
        confirmedDeceased: "Deces confirme",
      },
      confirmDeathPrompt:
        "Confirmer que cette personne ou cet animal doit etre marque comme deces confirme ? A utiliser seulement si l'information vient d'une source credible.",
      confirmStatusCorrectionPrompt:
        "Vous allez modifier le statut de « {from} » a « {to} ». Continuer ?",
      noPrimaryAction: "Cette tache ne demande pas d'action benevole de votre part pour le moment.",
      duplicateTitle: "Cela peut concerner une personne deja signalee.",
      duplicateDescription: "Comparez les details avant de regrouper les signalements.",
      noDuplicateSuggestions: "Aucun signalement ouvert n'est assez similaire pour etre propose.",
      openSuggestedCase: "Voir la correspondance possible",
      markPossibleDuplicate: "Garder separes",
      keepSeparate: "Garder separes",
      keepSeparateSuccess: "Les signalements restent separes.",
      confirmDuplicate: "Regrouper les signalements",
      matchReasons: {
      ...
      foundSafeSuccess: "La tache est marquee comme retrouvee en securite.",
      confirmDeathSuccess: "La tache est marquee comme deces confirme.",
      returnSuccess: "La tache a ete remise en attente.",
