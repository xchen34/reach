export const fr = {
  ...
  staff: {
    ...
    cases: {
      ...
      summaryTitle: "Resume de la file",
      listTitle: "Signalements regroupes",
      listDescription: "Chaque carte regroupe des signalements lies afin que des benevoles puissent verifier les mises a jour avant publication.",
    ...
    detail: {
      ...
      statusPanelTitle: "Decision sur le statut de la fiche",
      statusChangeLabel: "Mettre a jour le statut de la fiche",
      statusChangeHint: "Choisissez le statut qui correspond le mieux au resultat actuel de la verification.",
