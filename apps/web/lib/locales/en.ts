export const en = {
  ...
  home: {
    ...
    emergencyNumbersTitle: "Emergency Contacts & Dispatch",
    emergencyNumbers: [
      { label: "Emergency Services / Police", number: "112 / 17", desc: "For immediate danger or rescue" },
      { label: "Medical Emergency (SAMU)", number: "15", desc: "For critical medical situations" },
      { label: "Fire & Rescue (Sapeurs-Pompiers)", number: "18", desc: "For fires, accidents & entrapment" },
    ],
    coordinationGroupsTitle: "Community & Volunteer Coordination Groups",
    coordinationGroups: [
      {
        key: "family_search",
        title: "Family Search & On-Site Coordination",
        desc: "Connect with on-site volunteers helping families search for missing loved ones.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-family-search",
      },
      {
        key: "volunteer_join",
        title: "Volunteer Registration & Onboarding",
        desc: "For individuals who want to offer their time as volunteers in response operations.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-volunteers",
      },
      {
        key: "materials_donations",
        title: "Material & Supply Donations",
        desc: "For offering food, water, clothing, hygiene supplies, or emergency equipment.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-supplies",
      },
      {
        key: "shelter_housing",
        title: "Temporary Shelter & Accommodation",
        desc: "For community members who can offer emergency housing, rooms, or space.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-shelter",
      },
      {
        key: "civil_medical",
        title: "Civil Medical Support & Health Volunteers",
        desc: "For doctors, nurses, first-aiders, and medical professionals offering aid.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-medical",
      },
      {
        key: "animal_rescue",
        title: "Animal Rescue & Veterinary Volunteers",
        desc: "For pet rescue teams, veterinary professionals, and animal foster volunteers.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-animal-rescue",
      },
      {
        key: "missing_persons_tracker",
        title: "Missing Persons Registry & Verification",
        desc: "For volunteers coordinating reports and verifying records to avoid duplicate files.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-tracker",
      },
      {
        key: "language_support",
        title: "Language Support & Translation Team",
        desc: "For multilingual volunteers helping foreigners communicate with emergency services.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-languages",
      },
      {
        key: "logistics_transport",
        title: "Logistics & Transport Coordination",
        desc: "For volunteer drivers, vehicle coordinators, and logistics planners to route supplies.",
        cta: "Join WhatsApp Group",
        href: "https://chat.whatsapp.com/sample-logistics",
      },
    ],
    actions: {
      safe: {
  ...
  board: {
    ...
    publicStatuses: {
      // These name the same four states as staff.cases.operationalStatuses, so they
      // use the same short wording. The "recorded by Reach, not official" caveat
      // lives in the description and in board.statusDisclaimerParagraphs — it does
      // not need to be re-stated inside every pill.
      unassigned: {
  ...
  staff: {
    ...
    cases: {
      ...
      taskBoardTitle: "Dashboard",
      taskBoardDescription: "Review incoming reports, merge valid duplicates into cases, and track volunteer follow-up in one place.",
      ...
      followUpOverviewTitle: "Status overview",
      followUpOverviewDescription: "Filter the queue by status and review the counts before you open the list.",
      myFollowUpTitle: "My follow up",
      myFollowUpDescription: "Cases currently assigned to you for active follow-up.",
      myFollowUpCountLabel: "My follow up",
      myFollowUpEmpty: "You do not have any assigned follow-up cases right now.",
      followUpListTitle: "Combined follow-up list",
      followUpListDescription: "Incoming reports and cases share one workspace so the first step is always visible.",
      noFollowUpItemsYet: "No follow-up items are in the queue yet.",
      noFollowUpItemsMatchFilter: "No follow-up items match this filter.",
      duplicateReviewTitle: "Possible duplicates",
      duplicateReviewDescription: "Find same-name cards, choose the primary case, then merge duplicate cases or incoming reports into it.",
      findDuplicatesAction: "Find possible duplicates",
      duplicateReviewEmpty: "No same-name duplicates are visible in this workspace.",
      primaryCaseLabel: "Primary case",
      mergeDuplicateGroupAction: "Merge into primary",
      duplicateMergeSuccess: "Duplicate records were merged and logged.",
      duplicateMergeError: "The duplicate merge could not be saved. Try again.",
      duplicateReportsOnlyHint: "Create one help-list case first, then merge the remaining reports into it.",
      mergeSearchLabel: "Search cases",
      mergeSearchPlaceholder: "Search name, code, or location",
      mergeSearchEmpty: "No matching cases",
      openCombinedCaseAction: "Open combined case",
      linkedCaseLabel: "Combined with",
      reportCodeLabel: "Report code",
      reportSourceLabel: "Source",
      reportLanguageLabel: "Language",
      reportRelationshipLabel: "Reporter relationship",
      reportContactLabel: "Permission to contact",
      reportFirstHandLabel: "First hand",
      reportPermissionYes: "Yes",
      reportPermissionNo: "No",
      reportFallback: "Not provided",
      ...
      allIncidentsLabel: "All active incidents",
      ...
      followUpStatusFilters: {
        all: "All",
        needs_to_be_viewed: "Need to be viewed",
        waiting_for_volunteer: "Waiting for a volunteer",
        being_followed_up: "Being followed up",
        found_safe: "Found safe",
        found_dead: "Confirmed deceased",
      },
      pagination: {
        previous: "Previous",
        next: "Next",
      ...
      viewReportAction: "View full report",
      ...
      noteLabel: "Note",
      noteBadgeLabel: "Note",
      noteSaveAction: "Save note",
      noteSaving: "Saving...",
      noteCancelAction: "Cancel",
      noteRequired: "Write a note before saving.",
      noteTooLong: "Notes can be at most 100 characters.",
      noteSaveError: "The note was not saved. Try again.",
      ...
      reportStatuses: {
        awaiting_review: "Need to be viewed",
    ...
    reportDetail: {
      eyebrow: "Incoming report",
      fullReportTitle: "Full report",
      sourceTitle: "Source and contact",
      triageLogTitle: "Triage log",
      rawAnswersTitle: "Original form answers",
      backToList: "Back to follow-up workspace",
      ...
      emptyTriageLog: "No triage actions have been recorded yet.",
      triageActions: {
        create_case: "Created case",
        link_existing_case: "Linked to existing case",
        mark_out_of_scope: "Marked out of scope",
        mark_invalid_or_insufficient: "Marked invalid or insufficient",
        note: "Note",
      },
    },
    detail: {
      ...
      // Same wording as staff.cases.operationalStatuses: these name the same four
      // states, and using "Pending" / "In progress" here made the change-status
      // dropdown and the change log read as a different vocabulary.
      correctionStatuses: {
        unassigned: "Waiting for a volunteer",
        inProgress: "Being followed up",
      ...
      correctionStatusHints: {
        unassigned: "No volunteer is assigned. The case returns to the open queue.",
        inProgress: "A volunteer owns the case and is actively following it up.",
        foundAlive: "The person or pet has been confirmed safe. This closes the case.",
        confirmedDeceased: "Death confirmed by a credible source. This closes the case.",
      },
      confirmSafePrompt:
        "Mark this person or pet as found safe? This closes the case and updates the public board. Use this only when the information comes from a credible source.",
      confirmDeathPrompt:
        "Confirm that this person or pet should be marked as confirmed deceased? Use this only when the information comes from a credible source.",
